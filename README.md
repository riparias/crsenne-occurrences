# Contrat de Rivière Senne observations
...
source data → Darwin Core [mapping script](src/dwc_mapping.Rmd) using [SQL](SQL) → generated [Darwin Core files](data/processed)
